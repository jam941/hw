        ...
        for idx2 in range(len(string2)-1):
            ...
            if string1[idx1] == string2[idx2]:
                ...
                while string1[idx1 + this_match_count] == string2[idx2 + this_match_count]:
                    this_match_count += 1
                    if(this_match_count + idx1 >= string1_len or this_match_count + idx2 >= string2_len):
                        break
...
def test():
    print(match('peanut','can') == 2)
    print(match('chair','chair')==5)
    print(match('mud','air') == 0)
    print(match('cheeseburger',"burglar") == 4)
